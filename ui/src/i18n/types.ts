...
export interface Translations {
  ...
  commandCenter: {
    ...
    nav: Record<
      'newChat' | 'settings' | 'skills' | 'messaging' | 'visualQ' | 'artifacts',
  ...
  composer: {
    ...
    projectPmNewSessionPlaceholders: readonly string[]
    projectPmFollowUpPlaceholders: readonly string[]
    startVoice: string
    queueMessage: string
    steer: string
    stop: string
  ...
  shell: {
    ...
    paneControls: string
    projectChatToggle: string
    projectChatOpen: string
    projectChatClose: string
  ...
  delivery: {
    projectIntegrations: {
      ...
      targetJiraLabel: string
      targetJiraPlaceholder: string
      targetJiraLoading: string
      targetJiraSaving: string
      targetJiraSaved: string
      targetJiraEmpty: string
      targetJiraSavedHint: string
    }
  }
