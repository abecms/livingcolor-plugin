  ...
  delivery: {
    projectIntegrations: {
      ...
      automationSectionDescription:
        'Provision delivery agents, discover GitLab repositories, and wire project automation for autonomous delivery.',
      targetRepoSectionTitle: 'Target GitLab repository',
      ...
      targetRepoLoading: 'Loading GitLab repositories…',
      targetRepoSaving: 'Saving repository…',
      targetRepoSaved: 'Target repository saved.',
      targetRepoEmpty: 'No GitLab repositories were returned. Check your token scopes or reload the page.',
      targetRepoSavedHint: 'Re-run Setup automation to refresh agent manifests after changing the repository.',
      mergeTargetSectionTitle: 'Merge target branch',
      mergeTargetSectionDescription:
        'Choose the GitLab branch that published merge requests should target (for example develop or main).',
      mergeTargetLabel: 'Integration branch',
      mergeTargetPlaceholder: 'e.g. develop',
      mergeTargetSaving: 'Saving merge target branch…',
      mergeTargetSaved: 'Merge target branch saved.',
      mergeTargetSavedHint: 'The publisher agent uses this branch when creating merge requests.',
