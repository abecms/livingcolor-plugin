...
export const en: Translations = {
  ...
  boot: {
    ready: 'LivingColor is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading LivingColor settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting LivingColor…'
    },
    errors: {
      backgroundExited: 'LivingColor background process exited.',
      backgroundExitedDuringStartup: 'LivingColor background process exited during startup.',
    ...
    failure: {
      title: "LivingColor couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your LivingColor backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update LivingColor',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting LivingColor.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to LivingColor defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let LivingColor follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'LivingColor checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading LivingColor configuration...',
    ...
    gateway: {
      ...
      intro:
        'LivingColor starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running LivingColor backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private LivingColor backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote LivingColor backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /livingcolor.',
      ...
      restartingMessage: 'LivingColor will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · LivingColor ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. LivingColor runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      managedIncluded: 'Included with a managed subscription — sign in to Managed Portal to activate.',
      noApiKeyRequired: 'No API key required.',
      postSetup: step =>
        `This provider needs an extra setup step (${step}). Run it from the CLI with LivingColor tools for now.`
    }
  },
  ...
  commandCenter: {
    ...
    nav: {
      newChat: { title: 'New workstream', detail: 'Start a fresh management thread' },
      settings: { title: 'Settings', detail: 'Configure LivingColor desktop' },
      skills: { title: 'Workflows & Tools', detail: 'Enable manager workflows, toolsets, and providers' },
      messaging: { title: 'Messaging', detail: 'Set up Slack, Teams, Discord, and Email' },
      visualQ: { title: 'VisualQ', detail: 'Visual regression, functional tests, and tracking QA' },
      artifacts: { title: 'Artifacts', detail: 'Browse generated outputs' }
    },
    sectionEntries: {
      sessions: { title: 'Workstreams panel', detail: 'Search, pin, and manage workstreams' },
    ...
    hermesActiveSessions: (version, count) => `LivingColor ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@livingcolor:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent LivingColor environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. LivingColor will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    groupAriaUngrouped: 'Group workstreams by project',
    ...
    row: {
      ...
      untitledPlaceholder: 'Untitled workstream',
      ageNow: 'now',
      ageDay: 'd',
      ageHour: 'h',
      ageMin: 'm'
  ...
  composer: {
    ...
    placeholderStarting: 'Starting LivingColor...',
    placeholderReconnecting: 'Reconnecting to LivingColor…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'Plan this sprint',
      'Review delivery risk',
      'What is blocking the team?',
      'Turn this initiative into Jira-ready work',
      'Prepare a standup digest',
      'Prepare a VisualQ update',
    ...
    projectPmNewSessionPlaceholders: [
      'Show sprint status',
      'Change a ticket estimate',
      'Swap two sprint tickets',
      'Remove a ticket from the sprint',
      'Run daily analysis',
      'Approve a ticket for development'
    ],
    projectPmFollowUpPlaceholders: [
      'Adjust the estimate',
      'Reorder the sprint',
      'What changed?',
      'Add another ticket to the sprint',
      'Summarize blockers',
      'Send follow-up'
    ],
    ...
    commandDescs: {
      ...
      '/new': 'start a new workstream',
      '/goal': 'set the initiative or sprint goal',
      '/agents': 'review active follow-ups',
      '/queue': 'queue the next management prompt',
      '/resume': 'resume a prior workstream'
    },
    hotkeyDescs: {
      '@': 'reference project context, files, or URLs',
    ...
    attachUrlDesc: 'LivingColor will fetch the page and include it as context for this turn.',
    ...
    snippetsTitle: 'Manager workflows',
    snippetsDesc: 'Pick a Jira or VisualQ workflow starter to drop into the composer.',
    dropFiles: 'Drop files to attach',
    dropSession: 'Drop to link this chat',
    snippets: {
      sprintPlan: {
        label: 'Sprint plan',
        description: 'Break an initiative into Jira-ready priorities, owners, risks, and milestones.',
        text: 'Create a sprint plan for this initiative. Include Jira-ready priorities, owners, risks, dependencies, and milestones.'
      },
      deliveryRiskReview: {
        label: 'Delivery risk review',
        description: 'Assess delivery risks, blockers, dependencies, and stakeholder impact.',
        text: 'Review this delivery situation as an engineering manager. Summarize risks, blockers, dependencies, stakeholder impact, and the next decision needed.'
      },
      assignFollowUp: {
        label: 'Assign follow-up',
        description: 'Turn a workstream into clear owner actions and acceptance criteria.',
        text: 'Turn this workstream into clear follow-ups with owner, goal, context, acceptance criteria, due date, and verification needed.'
      },
      visualQDigest: {
        label: 'VisualQ digest',
        description: 'Prepare a concise VisualQ update with progress, blockers, owners, and next actions.',
        text: 'Prepare a VisualQ update from this context. Include progress, blockers, owners, risks, and next actions.'
      }
    }
  },
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      restart: 'Restarting LivingColor…',
    ...
    unsupportedMessage: 'This version of LivingColor can’t update itself from inside the app.',
    connectionRetry: 'Check your connection and try again.',
    latestBody: 'You’re running the latest version.',
    allSetTitle: 'You’re all set',
    availableTitle: 'New update available',
    availableBody: 'A new version of LivingColor is ready to install.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed LivingColor from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'LivingColor will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The LivingColor updater will take over in its own window and reopen LivingColor when it’s done.',
    applyingClose: 'LivingColor will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'LivingColor needs a one-time install',
    ...
    settingUpTitle: 'Setting up LivingColor',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another LivingColor CLI or desktop instance is running. Stop any running LivingColor instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The LivingColor installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with LivingColor",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'LivingColor is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting LivingColor…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run LivingColor',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point LivingColor at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — LivingColor connects automatically',
      loopback: 'Opens your browser to sign in — LivingColor connects automatically',
    ...
    authorizeThere: 'Authorize LivingColor there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize LivingColor there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid managed subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    projectChatToggle: 'Open project chat',
    projectChatOpen: 'Open chat',
    projectChatClose: 'Close chat',
    ...
    statusbar: {
      ...
      desktopVersion: version => `LivingColor v${version}`,
      ...
      gatewayTitle: 'LivingColor inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. LivingColor will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'LivingColor is restarting...',
      askRestart: 'Ask LivingColor to restart the server',
      lookingRestart: taskId => `LivingColor is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'LivingColor is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `LivingColor finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'LivingColor could not restart the server.',
      stillWorking:
        'LivingColor is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'LivingColor is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'LivingColor gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.livingcolor/config.yaml). LivingColor won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'LivingColor needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'LivingColor needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart LivingColor to use Save Image.',
    restartToSaveImages: 'Restart LivingColor to save images',
  ...
  delivery: {
    projectIntegrations: {
      ...
      updateJiraCredentials: 'Update Jira credentials',
      updateGitLabCredentials: 'Update GitLab credentials',
      updateGitHubCredentials: 'Update GitHub credentials',
      vcsProviderSectionTitle: 'Version control provider',
      vcsProviderSectionDescription:
        'Choose whether this project publishes approved work to GitLab merge requests or GitHub pull requests.',
      vcsProviderLabel: 'VCS provider',
      vcsProviderGitLab: 'GitLab',
      vcsProviderGitHub: 'GitHub',
      vcsProviderSaving: 'Saving VCS provider…',
      setupAutomation: 'Setup automation',
      setupAutomationBusy: 'Setting up automation…',
      setupAutomationSuccess: projectKey => `Automation enabled for ${projectKey}`,
      setupAutomationDisabledTooltip: missing => `Connect ${missing} before setting up automation.`,
      missingPrerequisiteJira: 'Jira',
      missingPrerequisiteGitLab: 'GitLab',
      missingPrerequisiteGitHub: 'GitHub',
      automationSectionTitle: 'Project automation',
      automationSectionDescription:
        'Provision delivery agents, discover repositories, and wire project automation for autonomous delivery.',
      targetRepoSectionTitle: (forge: string) => `Target ${forge} repository`,
      targetRepoSectionDescription:
        'Choose the default repository for delivery automation. Pick the correct codebase before running Setup automation.',
      targetRepoLabel: 'Default repository',
      targetRepoPlaceholder: 'Select a repository',
      targetRepoLoading: (forge: string) => `Loading ${forge} repositories…`,
      targetRepoSaving: 'Saving repository…',
      targetRepoSaved: 'Target repository saved.',
      targetRepoEmpty: (forge: string) =>
        `No ${forge} repositories were returned. Check your token scopes or reload the page.`,
      targetRepoSavedHint: 'Re-run Setup automation to refresh agent manifests after changing the repository.',
      mergeTargetSectionTitle: 'Integration branch',
      mergeTargetSectionDescription: (forge: string, reviewRequest: string) =>
        `Choose the ${forge} branch that published ${reviewRequest === 'PR' ? 'pull requests' : 'merge requests'} should target (for example develop or main).`,
      mergeTargetLabel: 'Integration branch',
      mergeTargetPlaceholder: 'e.g. develop',
      mergeTargetSaving: 'Saving integration branch…',
      mergeTargetSaved: 'Integration branch saved.',
      mergeTargetSavedHint: (reviewRequest: string) =>
        `The publisher agent uses this branch when creating ${reviewRequest === 'PR' ? 'pull requests' : 'merge requests'}.`,
      forgeSectionDescription: (forge: string, reviewRequest: string) =>
        `${reviewRequest} drafts, branch creation, and repository workflows use the ${forge} MCP server. Connect ${forge} before starting delivery work.`,
      jiraSectionDescription: projectKey =>
        `Daily analysis scans ${projectKey} tickets through the Jira MCP server. Connect Jira before running analysis.`,
      targetJiraSectionTitle: 'Linked Jira project',
      targetJiraSectionDescription:
        'Choose which Jira project daily analysis and readiness scans should use for this LivingColor project.',
      targetJiraLabel: 'Jira project',
      targetJiraPlaceholder: 'Select a Jira project',
      targetJiraLoading: 'Loading Jira projects…',
      targetJiraSaving: 'Saving Jira project…',
      targetJiraSaved: 'Linked Jira project saved.',
      targetJiraEmpty: 'No Jira projects were returned. Check your token scopes or reconnect Jira.',
      targetJiraSavedHint: 'Daily analysis and readiness scans use this Jira project key.'
    }
  },
